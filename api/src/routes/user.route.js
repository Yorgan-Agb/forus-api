...
import { completeProfile, seeMyProfile, modifyProfile } from '../controllers/user.controller.js';

export const userRouter = Router();

// Create a route for completing user profile
userRouter.post('/complete-profile', jwtCheck, validateUserProfile, completeProfile);
...
userRouter.put('/modify-profile', jwtCheck, getUserFromToken, validateUserProfile, modifyProfile);
